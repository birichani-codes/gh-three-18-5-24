...
const ContactForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch('http://localhost:5000/submit-contact-form', {
        method: 'POST',
        headers: {
      ...
      <div className="container">
        ...
        <form className="contact-form align-with-logo" id="contact-form" onSubmit={handleSubmit}>
          <div className="mb-3" style={{ width: '60%' }}>
            ...
            <input type="text" className="form-control expandable-input" id="your_name" name="your_name" value={formData.your_name} onChange={handleInputChange} required style={{ fontSize: '20px', backgroundColor: '#0C0A00', color: 'gold', borderColor: 'gold' }} />
          </div>
          <div className="mb-3" style={{ width: '60%' }}>
            <label htmlFor="email" className="expandable-label">Email:</label>
            <input type="email" className="form-control expandable-input" id="email" name="email" value={formData.email} onChange={handleInputChange} required style={{ fontSize: '20px', backgroundColor: '#0C0A00', color: 'gold', borderColor: 'gold' }} />
            <div id="email-validation-message"></div>
          </div>
          <div className="mb-3" style={{ width: '60%' }}>
            <label htmlFor="subject" className="expandable-label">Subject:</label>
            <input type="text" className="form-control expandable-input" id="subject" name="subject" value={formData.subject} onChange={handleInputChange} required style={{ fontSize: '20px', backgroundColor: '#0C0A00', color: 'gold', borderColor: 'gold' }}/>
          ...
          <div className="mb-3" style={{ width: '60%' }}>
            ...
            <div className="captcha-input">
              ...
              <input type="text" className="form-control" id="captcha" name="captcha" value={formData.captcha} onChange={handleInputChange} required style={{ fontSize: '20px', backgroundColor: '#0C0A00', color: 'gold', borderColor: 'gold'  }} />
